...
import { type AffiliateLoginPayload, useAffiliateStore, useNotificationsStore } from '@/stores'
...
const isAffliateLinkValid = ref(false)
onMounted(()=>{
  affiliateStore.validateAffiliateLink(props.referrer)
    .then(resp=>{
      if(resp.result === 'ok'){
        isAffliateLinkValid.value = true
      }
      else{
        showAlert({
...
const handleLogin = () => {
  ...
  if(phoneNoMeta.validated && phoneNoMeta.valid){
    ...
    affiliateStore.affiliateUserPhone({
    ...
    notificationStore.addNotification('please fill in the required fields', 'error')
...
<template>
  <div  v-if="isAffliateLinkValid"
    class="bg-habahaba-500 d-flex align-items-center justify-content-center"
    style="height: 100vh"
  >
      ...
      <div class="row">
        <div class="d-flex  flex-md-row flex-column">
          <div class="col d-flex justify-content-center">
            <img src="../../../public/images/OJZ2LI0-removebg-preview.png" alt="savings" class="referrer-image"/>
          </div>
          <div class="col align-content-center">
            ...
            <div class="card shadow-lg border-0 rounded-lg p-4">
              <div class="justify-content-center">
                ...
                <h4 class="text-center text-habahaba-800">
                  Welcome to Habahaba
                </h4>
              ...
              <div class="card-body">
                ...
                <form @submit.prevent="handleLogin">
                  ...
                  >
                    ...
                    <span v-else class="spinner-border text-habahaba-200" role="status">
